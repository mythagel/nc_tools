...
#ifndef RS274_TRANSFORM_H_
#define RS274_TRANSFORM_H_
#include "base/rs274_base.h"

class rs274_transform : public rs274_base
{
private:
...
public:
	rs274_transform(boost::program_options::variables_map& vm);

	virtual ~rs274_transform() = default;
};

#endif /* RS274_TRANSFORM_H_ */
